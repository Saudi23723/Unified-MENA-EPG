...
def write_xml(events):
    tv = ET.Element(
        "tv",
        {"generator-info-name": "Thmanyah Sports EPG FINAL v11"},
    )
...
def main():
    log("THMANYAH FINAL v11 | matches_today2 LAYOUT-AWARE ROW OCR | SOURCE TIME ONLY | 365 + Telegram CHANNEL-ONLY | TIVIMATE AUTO-CONVERT | NO ABU DHABI/LAS VEGAS")
