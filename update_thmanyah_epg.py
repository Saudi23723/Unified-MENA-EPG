...
def write_xml(events):
    tv = ET.Element(
        "tv",
        {"generator-info-name": "Thmanyah Sports EPG FINAL v6"},
    )
...
def main():
    log("THMANYAH FINAL v6 | SOURCE TIME ONLY | 365 + matches_today2 OCR CHANNEL-ONLY | TIVIMATE AUTO-CONVERT | NO ABU DHABI/LAS VEGAS")
