...
def main():
    log("THMANYAH FINAL v5.3.1 | SOURCE TIME ONLY | 365 CHANNEL-ONLY | TIVIMATE AUTO-CONVERT | NO ABU DHABI/LAS VEGAS")
    ...
    # collect_numbered_365() already deduplicates channel-only metadata.
    # Do NOT pass these records to dedupe(), which is for timed events and expects a "start" field.
    confirmations = confirmations_365
