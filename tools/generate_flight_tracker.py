...
def build_flights(rows, now_min):
    ...
    pages = max(1, DURATION // PAGE_SECONDS)
    return flights[:pages * PER_PAGE], pages
...
def render_frame(t, tz, date_label, out):
    ...
    text(d, (W-24, H-26), "Live data • refreshed every 20 min  •  Unified MENA EPG — Channel 6", F_SMALL, MUTED, anchor="ra")
