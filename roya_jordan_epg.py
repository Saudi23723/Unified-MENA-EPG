...
# -*- coding: utf-8 -*-
"""
Jordan — Roya TV / Roya News — full official general-programming EPG.
...
`day_number` is an offset from today (UTC day, 0 = today, negative = past,
positive = future). Each response carries every Roya channel's full-day
programme list (title, description, thumbnail, unix start/stop). Nothing
here is invented — every field comes straight from that API.
"""
